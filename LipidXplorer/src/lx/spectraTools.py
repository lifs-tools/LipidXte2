            ...
            for j in sc.listSurveyEntry:
                ...
                if (
                    ...
                    for k in sc.listSamples:
                        if (
                            j.dictIntensity.has_key(k)
                            and j.dictIntensity[k] != 0
                        ):
                            percsum += 1
                    ...
                    breakBool = False
                    if i.has_key("minIntensityDelta") or i.has_key(
                        "maxIntensityDelta"
                    ):
                        dictRelIntensity = {}
                        ...
                        for k in sc.listSamples:
                            for l in sc.listSamples:
                                if dictRelIntensity.has_key(
                                    k
                                ) and dictRelIntensity.has_key(l):
                                    if (
                                        abs(
                                            dictRelIntensity[k]
                                            - dictRelIntensity[l]
...
a Sequence object. Possible options are:
    ...
    if options.has_key("MSMStolerance"):

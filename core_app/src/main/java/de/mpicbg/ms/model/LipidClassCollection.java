...
public class LipidClassCollection extends ModifiableObservableListBase< LipidClass >
{
   ...
   private void parseClassText()
   {
      ...
      while ( st.hasMoreTokens() )
      {
         ...
         list.add( new LipidClass( lipid, AliphaticMoiety.valueOf( aliphaticMoiety ), Integer.parseInt( faAnions ), Integer.parseInt( sn2 ), Integer.parseInt( sym ), Integer.parseInt( sn1 ) ) );
      }
   }

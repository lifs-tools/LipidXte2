...
public class ParetoChart< X, Y > extends XYChart< X, Y >
{
   ...
   private static class StyleableProperties
   {
      ...
      private static final CssMetaData< ParetoChart< ?, ? >, Number > CATEGORY_GAP =
              new CssMetaData< ParetoChart< ?, ? >, Number >( "-fx-category-gap",
                      SizeConverter.getInstance(), 10.0 )
              {
                 ...
                 @Override public StyleableProperty< Number > getStyleableProperty( ParetoChart< ?, ? > node )
                 {
    ...
    * @since JavaFX 8.0
    */
   public List< CssMetaData< ? extends Styleable, ? > > impl_getStyleableProperties()
   {

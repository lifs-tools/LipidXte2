...
_lr_action_items = {
    "error": ([0, 1, 9, 35,], [5, 5, -2, -1,]),
    "QUERYNAME": ([0, 1, 9, 35,], [6, 6, -2, -1,]),
    "IDENTIFY": (
        [0, 1, 9, 10, 11, 13, 35, 37, 98, 172, 216,],
        [7, 7, -2, 7, -9, 7, -1, -8, -12, -10, -11,],
    ),
    "$end": ([1, 9, 35,], [0, -2, -1,]),
    "SEMICOLON": (
        [
    ...
    "DEFINE": (
        [3, 5, 10, 11, 13, 37, 71, 98, 172, 216,],
        [12, 12, 12, -9, 12, -8, -6, -12, -10, -11,],
    ),
    "IS": (
        [6, 38, 101, 102, 103, 104, 105, 106, 112,],
        [14, 68, 140, 141, 142, 143, 144, 145, 150,],
    ),
    "ID": (
        [
            7,
    ...
    "NOT": (
        [7, 19, 20, 42, 47, 48, 49, 50, 51, 52, 75, 116, 117, 151, 152,],
        [20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 117, 117, 117, 117, 117,],
    ),
    "FLOAT": (
        [
            7,
    ...
    "LBRACE": ([17, 54, 76, 124, 165,], [45, 45, 121, 166, 199,]),
    "IN": (
        [
            17,
            22,
    ...
    "DA": ([29, 30, 131, 181, 182,], [59, 61, 61, 59, 61,]),
    "PPM": ([29, 30, 131, 181, 182,], [60, 63, 63, 60, 63,]),
    "RES": ([30, 131, 182,], [62, 62, 62,]),
    "MS1": ([56,], [91,]),
    "MS2": ([56,], [92,]),
    "DBR": ([70, 139,], [101, 101,]),
    "CHG": ([70, 139,], [102, 102,]),
    "MASSRANGE": ([70, 139,], [103, 103,]),
    "MINOCC": ([70, 139,], [104, 104,]),
    "MAXOCC": ([70, 139,], [105, 105,]),
    "TOLERANCE": ([70, 139,], [106, 106,]),
    "RBRACE": ([77, 163, 164, 200, 214,], [122, 197, 198, 215, 221,]),
    "NEUTRALLOSS": ([173,], [201,]),
    "PERCENT": ([185,], [205,]),
}
...
_lr_goto_items = {
    ...
    "script": ([0, 1,], [2, 8,]),
    "scriptname": ([0, 1,], [3, 3,]),
    "identification": ([0, 1, 10, 13,], [4, 4, 36, 39,]),
    "variables": ([3, 5,], [10, 13,]),
    "var": ([3, 5, 10, 13,], [11, 11, 37, 37,]),
    "tagname": ([7,], [15,]),
    "marks": ([7, 42,], [16, 72,]),
    "boolmarks": (
        [7, 19, 20, 42, 47, 48, 49, 50, 51, 52,],
        [18, 53, 55, 18, 83, 84, 85, 86, 87, 88,],
    ),
    "scan": (
        [7, 19, 20, 42, 47, 48, 49, 50, 51, 52,],
    ...
    "getQueryName": ([14,], [40,]),
    "evalMarks": ([16, 72,], [43, 107,]),
    "listcontent": ([34,], [66,]),
    "options": (
        [38, 90, 97, 190, 191, 192, 193, 194, 195, 196,],
        [69, 132, 138, 207, 208, 209, 210, 211, 212, 213,],
    ),
    "suchthat": ([43, 107,], [73, 146,]),
    "arguments": ([46, 220,], [79, 225,]),
    "expression": (
        [
            46,
            75,
    ...
    "scope": ([56,], [90,]),
    "optioncontent": ([70,], [99,]),
    "optionentry": ([70, 139,], [100, 174,]),
    "report": ([74, 108, 147, 183,], [109, 148, 184, 204,]),
    "reportContent": ([74, 108, 147, 183,], [110, 110, 110, 110,]),
    "rContent": ([74, 108, 110, 147, 183,], [111, 111, 149, 111, 111,]),
    "body": ([75,], [113,]),
    "bterm": ([75,], [114,]),
    "booleanterm": ([75, 116, 117, 151, 152,], [115, 153, 155, 187, 188,]),
    "expr": ([75, 116, 117, 151, 152,], [118, 118, 118, 118, 118,]),
}
...
_lr_productions = [
    ...
    ("onlyObj -> ID", "onlyObj", 1, "p_onlyObj_ID", "mfqlParser.py", 384),
    ("onlyObj -> list", "onlyObj", 1, "p_onlyObj_list", "mfqlParser.py", 390),
    (
        "onlyObj -> varcontent",
        "onlyObj",
        1,
    ...
    ("tagname -> ID", "tagname", 1, "p_tagname", "mfqlParser.py", 709),
    ("marks -> boolmarks", "marks", 1, "p_marks", "mfqlParser.py", 723),
    (
    ...
    ("body -> bterm", "body", 1, "p_body_bool", "mfqlParser.py", 835),
    ("bterm -> booleanterm", "bterm", 1, "p_bterm", "mfqlParser.py", 840),
    (

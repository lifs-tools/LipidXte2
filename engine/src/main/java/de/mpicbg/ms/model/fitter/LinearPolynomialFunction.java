 ...
 */
public class LinearPolynomialFunction implements UnivariateDifferentiableFunction, DifferentiableUnivariateFunction, Serializable
{
   /**
    * Serialization identifier
    */
   private static final long serialVersionUID = -7726511984204295583L;
   /**
    ...
    */
   public LinearPolynomialFunction( double c[] ) throws NullArgumentException, NoDataException
   {
      super();
   ...
   protected static double evaluate( double[] coefficients, double argument ) throws NullArgumentException, NoDataException
   {
      ...
      for ( int j = n - 2; j >= 0; j-- )
      {
         result = argument * result + coefficients[ j ] * coefficients[ n - 1 ];
      }
      return result;
   }
    ...
    */
   public LinearPolynomialFunction add( final LinearPolynomialFunction p )
   {
      ...
      return new LinearPolynomialFunction( newCoefficients );
   }
    ...
    */
   public LinearPolynomialFunction subtract( final LinearPolynomialFunction p )
   {
      // identify the lowest degree polynomial
    ...
    */
   public LinearPolynomialFunction negate()
   {
    ...
    */
   public LinearPolynomialFunction multiply( final LinearPolynomialFunction p )
   {
      ...
      for ( int i = 0; i < newCoefficients.length; ++i )
      {
         ...
         for (
                 int j = FastMath.max( 0, i + 1 - p.coefficients.length ); j < FastMath.min( coefficients.length, i + 1 ); ++j )
         {
   ...
   protected static double[] differentiate( double[] coefficients ) throws NullArgumentException, NoDataException
   {
      ...
      //		for (int i = n - 1; i > 0; i--) {
      //			result[i - 1] = i * coefficients[i] * ( (i == n - 1) ? 1 : -coefficients[n - 1]);
      //		}
      result[ 0 ] = 0.0;
      result[ 1 ] = coefficients[ 2 ] * coefficients[ 1 ];
      result[ 2 ] = 2 * coefficients[ 2 ];

      return result;
   }

   /**
    * Returns the derivative as a {@link LinearPolynomialFunction}.
    * @return the derivative polynomial.
    */
   public LinearPolynomialFunction polynomialDerivative()
   {
      return new LinearPolynomialFunction( differentiate( coefficients ) );
   }

   /**
    * Returns the derivative as a {@link org.apache.commons.math3.analysis.UnivariateFunction}.
   ...
   @Override public boolean equals( Object obj )
   {
      ...
      if ( !( obj instanceof LinearPolynomialFunction ) )
      {
         return false;
      }
      LinearPolynomialFunction other = ( LinearPolynomialFunction ) obj;
   ...
   public static class Parametric implements ParametricUnivariateFunction
   {
      ...
      public double[] gradient( double x, double... parameters )
      {
         ...
         gradient[ 0 ] = 1.0;
         gradient[ 1 ] = x / parameters[ 2 ];
         gradient[ 2 ] = x * x + x * parameters[ 1 ];
         //			double xn = 0.0;
      ...
      {
         return LinearPolynomialFunction.evaluate( parameters, x );
      }
   }
}

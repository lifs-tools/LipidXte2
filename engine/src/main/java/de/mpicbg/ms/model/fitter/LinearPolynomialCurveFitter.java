...
public class LinearPolynomialCurveFitter extends AbstractCurveFitter
{
    ...
    */
   private LinearPolynomialCurveFitter( double[] initialGuess, int maxIter )
   {
   ...
   {
      return new LinearPolynomialCurveFitter( newStart.clone(), maxIter );
   }
   ...
   {
      return new LinearPolynomialCurveFitter( initialGuess, newMaxIter );
   }
